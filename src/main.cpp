...
//                "{ w weight       |../models/VGGNet/VOC0712Plus/SSD_512x512_ft/VGG_VOC0712Plus_SSD_512x512_ft_iter_160000.caffemodel  | Detection parameter: Weight file | }"
                ...
                "{ l1p1_x         |840                   | Counting parameter: line 1 point 1 x coordinate  | }"
                "{ l1p1_y         |0                  | Counting parameter: line 1 point 1 y coordinate  | }"
                "{ l1p2_x         |840                   | Counting parameter: line 1 point 2 x coordinate  | }"
                "{ l1p2_y         |720                   | Counting parameter: line 1 point 2 y coordinate  | }"
                "{ l2p1_x         |840                   | Counting parameter: line 2 point 1 x coordinate  | }"
                "{ l2p1_y         |0                  | Counting parameter: line 2 point 1 y coordinate  | }"
                "{ l2p2_x         |840                   | Counting parameter: line 2 point 2 x coordinate  | }"
