...
const char* keys =
        {
                ...
                "{ m model        |../models/VGGNet/VOC0712/SSD_512x512/deploy.prototxt | Model file for detection | }"
                "{ w weight       |../models/VGGNet/VOC0712/SSD_512x512/VGG_VOC0712_SSD_512x512_iter_120000.caffemodel  | Weight file for detection | }"
                "{ th threshold   |0.1                   |  | }"
                "{ ocl opencl     |0                   |  | }"
                "{ co count       |1                   |  | }"
                "{ d direction    |1                   |  | }"
